...
const WhatsappForm = () => {
  ...
  const validatePhone = (phone) => {
    ...
    const isValid = phoneNumberPattern.test(phone) && cleanedPhone.length === 11
    return isValid
  }
  ...
  return (
    <div className="phone3:mx-auto text-paragraph3 phone3:text-paragraph4">
      ...
      <div className="flex justify-center">
        <button
          className="flex items-center w-full px-4 py-2 font-medium text-white transition bg-red-700 rounded-lg text-title1 h-14 phone2:h-14 phone3:h18 hover:bg-blue-500"
